...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name     = "${var.namespace}-PublicSubnet-${count.index}-${var.environment}"
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name     = "${var.namespace}-PublicRouteTable-${var.environment}"
    Scenario = var.scenario
  }
}
...
resource "aws_nat_gateway" "nat_gateway" {
  ...
  tags = {
    Name     = "${var.namespace}-NATGateway-${count.index}-${var.environment}"
    Scenario = var.scenario
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name     = "${var.namespace}-PrivateSubnet-${count.index}-${var.environment}"
    Scenario = var.scenario
  }
}
